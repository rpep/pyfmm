...
def test_CellFromIndex():
    assert (CellFromIndex(0) == (0,0,0)).all()
    assert (CellFromIndex(1) == (1,0,0)).all()
    assert (CellFromIndex(2) == (0,1,0)).all()
    assert (CellFromIndex(3) == (1,1,0)).all()
    assert (CellFromIndex(4) == (0,0,1)).all()
    assert (CellFromIndex(5) == (1,0,1)).all()
    assert (CellFromIndex(6) == (0,1,1)).all()
    assert (CellFromIndex(7) == (1,1,1)).all()
    assert (CellFromIndex(8) == (2,0,0)).all()
    assert (CellFromIndex(9) == (3,0,0)).all()
    assert (CellFromIndex(10) == (2,1,0)).all()
    assert (CellFromIndex(11) == (3,1,0)).all()
    assert (CellFromIndex(12) == (2,0,1)).all()
    assert (CellFromIndex(13) == (3,0,1)).all()
    assert (CellFromIndex(14) == (2,1,1)).all()
